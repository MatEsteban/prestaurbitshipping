...
if ($test_api_call) {
    ...
    $form_data['URBIT_API_TEST_TOKEN'] = Configuration::get('URBIT_API_TEST_TOKEN');
    $form_data['URBIT_API_URL'] = Configuration::get('URBIT_API_URL');
    $form_data['URBIT_API_TOKEN'] = Configuration::get('URBIT_API_TOKEN');
   ...
   /* Configuration::updateValue('URBIT_API_CUSTOMER_KEY', $_POST['URBIT_API_CUSTOMER_KEY']);
    ...
    Configuration::updateValue('URBIT_API_TEST_TOKEN', $_POST['URBIT_API_TEST_TOKEN']);
    Configuration::updateValue('URBIT_API_URL', $_POST['URBIT_API_URL']);
    Configuration::updateValue('URBIT_API_TOKEN', $_POST['URBIT_API_TOKEN']);
   ...
   */
    ...
    Configuration::updateValue('URBIT_API_TEST_TOKEN', Tools::getValue('URBIT_API_TEST_TOKEN'));
    Configuration::updateValue('URBIT_API_URL', Tools::getValue('URBIT_API_URL'));
    Configuration::updateValue('URBIT_API_TOKEN', Tools::getValue('URBIT_API_TOKEN'));
    ...
    if ($return->Message && !$return->data) {
        ...
        Configuration::updateValue('URBIT_API_TEST_TOKEN', $form_data['URBIT_API_TEST_TOKEN']);
        Configuration::updateValue('URBIT_API_URL', $form_data['URBIT_API_URL']);
        Configuration::updateValue('URBIT_API_TOKEN', $form_data['URBIT_API_TOKEN']);
...
//http://stackoverflow.com/questions/16606300/prestashop-inserting-values-to-the-database-showing-unexpected-t-string
   ...
   // $module_status = Tools::getValue('module_status');
    ...
    $data_array = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS("SELECT * FROM " . _DB_PREFIX_ . "configuration_data  WHERE `urb_carrier_id`='" . $data[0]['id_carrier'] . "'");
    ...
    */
    ...
    if (sizeof($return) == 0 &&  !isset($return)) {
        if (Tools::getValue('URBIT_ENABLE_TEST_MOD')) {
            ...
            $form_data['URBIT_API_TEST_TOKEN'] = "";
